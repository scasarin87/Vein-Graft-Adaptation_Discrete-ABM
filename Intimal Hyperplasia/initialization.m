...
% to the SMC/ECM ratio in order to maintain a uniform distribution
xxx=2.75; % calibrated (see BasicSolution-->xxx_calibration folder)
...
tau_depth = A(8); % rate of decay for shear stress influence across the wall, expressed in cell dimension.                         
...
%% Mechanical Model: thick cylinder 
...
type_cell=zeros(Nx,Ny); % it defines if the site contains SMC or ECM 
